(module
  ...
  (func $undefined_weak:main (type 2) (param i32 i32) (result i32)
    unreachable)
  (func $_start (type 7)
    (local i32)
    block  ;; label = @1
    ...
    unreachable)
  (func $print_num (type 6) (param i32)
    (local i32)
                                  ...
                                  block  ;; label = @16
                                    block  ;; label = @17
                                      ...
                                      block  ;; label = @18
                                        ...
                                        i32.const 0
                                        i64.const -1
                                        i64.store offset=4172 align=4
                                        i32.const 0
                                        i64.const 281474976776192
                                        i64.store offset=4164 align=4
                                        i32.const 0
                                        local.get 1
                                        i32.const 8
                                        i32.add
